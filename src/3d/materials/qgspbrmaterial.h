...
class _3D_EXPORT QgsPBRMaterial : public QgsMaterial
{
  ...
  protected:
    ...
    virtual QStringList fragmentShaderDefines();

    Qt3DRender::QEffect *mPBREffect = nullptr;
  ...
  private:
    ...
    Qt3DRender::QTechnique *mPBRGL3Technique = nullptr;
    Qt3DRender::QRenderPass *mPBRGL3RenderPass = nullptr;
    Qt3DRender::QShaderProgram *mPBRGL3Shader = nullptr;
