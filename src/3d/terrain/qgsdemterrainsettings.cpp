...
void QgsDemTerrainSettings::readXml( const QDomElement &, const QgsReadWriteContext & )
{

}

void QgsDemTerrainSettings::writeXml( QDomElement &, const QgsReadWriteContext & ) const
{
