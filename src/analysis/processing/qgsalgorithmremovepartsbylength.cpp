...
{
  return QObject::tr( "This algorithm takes a line layer and removes lines which are smaller than a specified length.\n\n"
...
{
  std::unique_ptr< QgsProcessingParameterDistance > minLength = std::make_unique< QgsProcessingParameterDistance >( QStringLiteral( "MIN_LENGTH" ),
      QObject::tr( "Remove parts with lengths less than" ),
      0.0,
