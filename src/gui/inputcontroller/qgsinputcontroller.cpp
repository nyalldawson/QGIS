...
#include "qgsgamepadcontroller.h"
...
QgsInputControllerManager::InputControllerType QgsAbstract2DMapController::type() const
{
  return QgsInputControllerManager::InputControllerType::Map2D;
}
...
QgsInputControllerManager::InputControllerType QgsAbstract3DMapController::type() const
{
  return QgsInputControllerManager::InputControllerType::Map3D;
}
