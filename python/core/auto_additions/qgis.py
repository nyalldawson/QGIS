...
QgsStyle.StyleEntity = Qgis.StyleEntity
# monkey patching scoped based enum
QgsStyle.SymbolEntity = Qgis.StyleEntity.Symbol
QgsStyle.StyleEntity.SymbolEntity = Qgis.StyleEntity.Symbol
QgsStyle.SymbolEntity.is_monkey_patched = True
QgsStyle.SymbolEntity.__doc__ = "Symbols"
QgsStyle.TagEntity = Qgis.StyleEntity.Tag
QgsStyle.StyleEntity.TagEntity = Qgis.StyleEntity.Tag
QgsStyle.TagEntity.is_monkey_patched = True
QgsStyle.TagEntity.__doc__ = "Tags"
QgsStyle.ColorrampEntity = Qgis.StyleEntity.ColorRamp
QgsStyle.StyleEntity.ColorrampEntity = Qgis.StyleEntity.ColorRamp
QgsStyle.ColorrampEntity.is_monkey_patched = True
QgsStyle.ColorrampEntity.__doc__ = "Color ramps"
QgsStyle.SmartgroupEntity = Qgis.StyleEntity.SmartGroup
QgsStyle.StyleEntity.SmartgroupEntity = Qgis.StyleEntity.SmartGroup
QgsStyle.SmartgroupEntity.is_monkey_patched = True
QgsStyle.SmartgroupEntity.__doc__ = "Smart groups"
QgsStyle.TextFormatEntity = Qgis.StyleEntity.TextFormat
QgsStyle.StyleEntity.TextFormatEntity = Qgis.StyleEntity.TextFormat
QgsStyle.TextFormatEntity.is_monkey_patched = True
QgsStyle.TextFormatEntity.__doc__ = "Text formats"
QgsStyle.LabelSettingsEntity = Qgis.StyleEntity.LabelSettings
QgsStyle.StyleEntity.LabelSettingsEntity = Qgis.StyleEntity.LabelSettings
QgsStyle.LabelSettingsEntity.is_monkey_patched = True
QgsStyle.LabelSettingsEntity.__doc__ = "Label settings"
QgsStyle.LegendPatchShapeEntity = Qgis.StyleEntity.LegendPatchShape
QgsStyle.StyleEntity.LegendPatchShapeEntity = Qgis.StyleEntity.LegendPatchShape
QgsStyle.LegendPatchShapeEntity.is_monkey_patched = True
QgsStyle.LegendPatchShapeEntity.__doc__ = "Legend patch shape (since QGIS 3.14)"
QgsStyle.Symbol3DEntity = Qgis.StyleEntity.Symbol3D
QgsStyle.StyleEntity.Symbol3DEntity = Qgis.StyleEntity.Symbol3D
QgsStyle.Symbol3DEntity.is_monkey_patched = True
QgsStyle.Symbol3DEntity.__doc__ = "3D symbol entity (since QGIS 3.14)"
Qgis.StyleEntity.__doc__ = "Entities involved in a style database.\n\n.. note::\n\n   Prior to 3.40 this was available as :py:class:`QgsStyle`.StyleEntity.\n\n.. versionadded:: 3.40\n\n" + '* ``SymbolEntity``: ' + Qgis.StyleEntity.Symbol.__doc__ + '\n' + '* ``TagEntity``: ' + Qgis.StyleEntity.Tag.__doc__ + '\n' + '* ``ColorrampEntity``: ' + Qgis.StyleEntity.ColorRamp.__doc__ + '\n' + '* ``SmartgroupEntity``: ' + Qgis.StyleEntity.SmartGroup.__doc__ + '\n' + '* ``TextFormatEntity``: ' + Qgis.StyleEntity.TextFormat.__doc__ + '\n' + '* ``LabelSettingsEntity``: ' + Qgis.StyleEntity.LabelSettings.__doc__ + '\n' + '* ``LegendPatchShapeEntity``: ' + Qgis.StyleEntity.LegendPatchShape.__doc__ + '\n' + '* ``Symbol3DEntity``: ' + Qgis.StyleEntity.Symbol3D.__doc__
# --
Qgis.StyleEntity.baseClass = Qgis
